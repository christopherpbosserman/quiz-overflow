...
app.get('/quiz-overflow', quizController.getQuestion, (req, res) => {
...
app.get('/quiz-overflowDB', quizControllerDB.getQuestion, (req, res) => {
...
app.get('/high-score', scoreController.getHighScore, (req, res) => {
  if (!res.locals.isLoggedIn) {
    return res.status(200).json('Invalid session');
  }
  return res.status(200).json(res.locals);
